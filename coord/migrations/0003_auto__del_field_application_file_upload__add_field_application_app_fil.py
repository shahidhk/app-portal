...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Application.file_upload'
        db.delete_column('coord_application', 'file_upload')

        # Adding field 'Application.app_file'
        db.add_column('coord_application', 'app_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Application.file_upload'
        db.add_column('coord_application', 'file_upload',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Application.app_file'
        db.delete_column('coord_application', 'app_file')
